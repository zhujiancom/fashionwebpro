...
<html>
  <head>
	...
	<script src="javascript/jquery-plugin/fotorama/fotorama.js" type="text/javascript"></script>
  	...
  	<div id="wrapper">
  		<jsp:include page="/frontend/header.jsp"></jsp:include>
  		 <div id="contentwrapper">
			<div id="contenttitle">
		    	<div class="title"><h1><s:property value="specnews.title"/></h1></div>
		    	<div class="otherinfor">
		        	<ul>
		            	<li><s:date name="specnews.news.publishDate" format="yyyy-MM-dd"/></li>
		                <li>&nbsp;&nbsp;|&nbsp;&nbsp;</li>
		            	<li><a href="javascript:history.go(-1);"><s:text name="back"/></a></li>
		            	<li>&nbsp;&nbsp;|&nbsp;&nbsp;</li>
		            	<li><a href="news_showPreItem.action?news.newsId=<s:property value='specnews.news.newsId'/>"><s:text name="pre"/></a></li>
		            	<li>&nbsp;&nbsp;|&nbsp;&nbsp;</li>
		                <li><a href="news_showNextItem.action?news.newsId=<s:property value='specnews.news.newsId'/>"><s:text name="next"/></a></li>
		            </ul>
		        </div>
		        <br />       
		        <!--<hr class="tpsep"  />-->
		    ...
		    <div class="fotorama" data-width="80%" data-ratio="1.5" data-hash="true" data-max-height="100%" data-nav="thumbs" data-fit="cover" data-allow-full-screen="native" data-thumb-width="72" data-thumb-height="48">
			      <s:iterator value="specnews.images" var="image">
		    ...
		    <div id="content">
		        ...
		        <textarea id="comment"><s:property value="specnews.content"/></textarea>
		        <div class="msg_caption">
