  			...
  			<div id="contenttitle">
		    	...
		    	<div class="otherinfor">
		        	<ul>
		            	...
		            	<li>&nbsp;&nbsp;|&nbsp;&nbsp;</li>
		            	<li><a href="<%=basePath %>designer/report/pre_<s:property value='reportvo.id'/>.html"><s:text name="pre"/></a></li>
		            	<li>&nbsp;&nbsp;|&nbsp;&nbsp;</li>
		                <li><a href="<%=basePath %>designer/report/next_<s:property value='reportvo.id'/>.html"><s:text name="next"/></a></li>
		            </ul>
		        </div>
		    </div>
