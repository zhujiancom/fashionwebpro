...
<html>
  <head>
    ...
    <title>My JSP 'runwayshow.jsp' starting page</title>
	...
	<script type="text/javascript">
	  $(function() {
	    $("video").osmplayer({
		  playlist:'menus/brand/playlist.xml',
	      width: '80%',
	      height: '500px'
	    });
	  });
  ...
  <body  oncontextmenu="return false" onselectstart="return false">
  	<div id="wrapper">
  		 <div id="mainwrapper">
        	...
        	<video src="<s:property value='runwayshowVO.runwayshow.runwayshowUrl'/>" poster="<s:property value='runwayshowVO.runwayshow.poster'/>"></video>
            ...
            <textarea id="comment"><s:property value="runwayshowVO.content"/>
              </textarea>
              <div class="msg_caption">
