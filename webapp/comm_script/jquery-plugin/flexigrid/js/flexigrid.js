        ...
        var g = {
            ...
            rePosDrag: function(){
                ...
                $('thead tr:first th:visible', this.hDiv).each(function(){
                    ...
                    //添加多选框 [修改后代码 时间：2012-08-07]------------开始----------第1处----- flexigrid.js 83行
                    if (p.showcheckbox) {
                    ...
                    //添加多选框 [修改后代码 时间：2012-08-07]------------结束----------第1处-----
                    $('div:eq(' + n + ')', g.cDrag).css({
                        'left': cdpos + 'px'
                    }).show();
                    cdleft = cdpos;
            ...
            dragStart: function(dragtype, e, obj){ //default drag function start
                if (dragtype == 'colresize') {//column resize
                    ...
                    if (dragtype == 'vresize') {//table resize
                        var hgo = false;
            ...
            addData: function(data){ //parse data
                ...
                if (p.dataType == 'json') {
                    $.each(data.rows, function(i, row){
                        ...
                        //添加多选框 [修改后代码 时间：2012-08-07]------------开始----第2处-----------
                        if (p.showcheckbox) {
                        
                            var cth = $('<th/>');
                            var objTr = $(tr);
                            var cthch = $('<input type="checkbox" value="' + objTr.attr("id")+ '"/>');
                        ...
                        //添加多选框 [修改后代码 时间：2012-08-07]------------结束----第2处-----------
...
function(){
            ...
            addRowProp: function(){
                $('tbody tr', g.bDiv).each(function(){
                    $(this).click(function(e){
                        ...
                        //添加多选框 [修改后代码 时间：2012-08-07]------------开始-------第3处--------
                        if (p.showcheckbox) {
                        ...
                        //添加多选框 [修改后代码 时间：2012-08-07]------------结束-------第3处--------
            ...
            autoResizeColumn: function(obj){
                ...
                var n = $('div', this.cDrag).index(obj), $th = $('th:visible div:eq(' + n + ')', this.hDiv), ol = parseInt(obj.style.left), ow = $th.width(), nw = 0, nl = 0, $span = $('<span />');
                $('body').children(':first').before($span);
                $span.html($th.html());
        ...
        if ($('th', g.hDiv).length) {
            ...
            //添加多选框 [修改后代码 时间：2012-08-07]------------结束--------第4处-------modify by zhujian
            if ($.browser.msie && $.browser.version < 7.0) 
