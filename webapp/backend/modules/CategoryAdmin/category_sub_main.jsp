...
<html>
  <head>
    ...
    <title>category_sub_main page</title>
	...
	<script type="text/javascript" src="<%=basePath%>backend/modules/CategoryAdmin/data/categorySubdata.js"></script>
  ...
  <body>
    <table id="categorySubValue" groupCd="<%=request.getParameter("groupCd") %>" style="display: none;"></table>
  </body>
</html>
